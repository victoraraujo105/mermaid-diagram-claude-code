...
Claude Code generates:
  ✓ flowchart_login_2025-12-23.md   (Mermaid markdown)
  ✓ flowchart_login_2025-12-23.html (Interactive HTML)

You: Open the HTML file in browser → Interactive diagram with zoom!
```
...
flowchart TD
    ...
    Check -->|✅ Yes| Success[✨ Done]
    Check -->|❌ No| Error[⚠️ Error]
```
...
- ✅ Mobile: Platform-specific emoji fonts
